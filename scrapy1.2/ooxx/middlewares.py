...
from twisted.internet.error import (ConnectError, ConnectionRefusedError,TimeoutError,ConnectionLost,TCPTimedOutError)
from twisted.web._newclient import ResponseNeverReceived
sys.path.append(r'C:\Users\Administrator\Desktop\scrapy1.2\ooxx')
